...
//	private String parentIds;// 所有父级编号
    ...
    private List<Article> childListActive = Lists.newArrayList();    // 拥有子分类列表
    ...
    public Map<String, Object> toSimpleObj() {
        ...
        map.put("id", id);
        map.put("name", name);
        map.put("childList", childListActive);
        return map;
    }

    public List<Article> getChildListActive() {
        return childListActive;
    }

    public void setChildListActive(List<Article> childListActive) {
        this.childListActive = childListActive;
    }
