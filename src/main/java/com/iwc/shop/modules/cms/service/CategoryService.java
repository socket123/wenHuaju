...
import com.iwc.shop.modules.cms.entity.Site;
...
import com.iwc.shop.modules.cms.dao.CategoryDao;
...
public class CategoryService extends TreeService<CategoryDao, Category> {
	...
	public List<Category> findList_all(Category category){
		return dao.findList_all(category);
	}
