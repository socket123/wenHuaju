...
public class AppAboutController extends AppBaseController {
	...
	public String list(HttpServletResponse response) {
        ...
        String desc = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;滁苏科技为客户提供休闲温馨的环境，以最真诚的态度服务于我们的客户，提供香浓的咖啡、健康的奶茶和美味的小吃。为了让客户享受更便捷的服务和优惠价格，我们开发了滁苏科技APP，欢迎使用。";
        String copyright = "Copyright © 2015";
        String company = "深圳市宝安区福永滁苏科技饮品店";
    ...
    public String address(HttpServletResponse response) {
        ...
        String desc1 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎光临滁苏科技饮品店。";
        String desc2 = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;滁苏科技提供最自然、最健康、最好吃的、最好喝的饮品和小吃。";
        String name = "门店名称：滁苏科技饮品店";
