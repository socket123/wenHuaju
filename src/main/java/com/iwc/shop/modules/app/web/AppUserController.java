...
import com.iwc.shop.modules.app.web.util.FlieUtil;
...
public class AppUserController extends AppBaseController {
     ...
     * @return
     */
    @RequestMapping("/set_user_name")
    public String set_user_name(HttpServletRequest request, HttpServletResponse response) {
     ...
     * @return
     */
    @RequestMapping("/set_user_img")
    public String set_user_img(HttpServletRequest request, HttpServletResponse response) {
        if (!isLoggedIn(request)) {
            return renderNotLoggedIn(response);
        }
        boolean result;
...
//            System.out.println(this.getClass().getResource("/"));
            String images = FlieUtil.GenerateImage(image, request.getSession().getServletContext().getRealPath("//"));
...
//        return "modules/app/user/index";
        String userId = request.getParameter("userId");
        String appLoginToken = request.getParameter("appLoginToken");
        modelMap.put("userId", userId);
        modelMap.put("appLoginToken", appLoginToken);
        return new ModelAndView("modules/app/user/index");
    ...
    public String register(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "modules/app/user/register";
    }

    // 进入设置页
    @RequestMapping(value = "/settting")
    public String settting(HttpServletRequest request, HttpServletResponse response) {

        return "modules/app/user/setting";
    }
    ...
    public String wallet(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "modules/app/user/wallet";
    }
    ...
    public String myOrder(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "modules/app/user/myOrder";
    }
    // 进入我的订单 订单详情
    @RequestMapping(value = "/myOrder_detail")
    public ModelAndView myOrder_detail(HttpServletRequest request, HttpServletResponse response,ModelMap modelMap){
        String orderId = request.getParameter("orderId");
        modelMap.put("orderId", orderId);
        return new ModelAndView("modules/app/user/myOrder_detail");
    ...
    public ModelAndView receivingAddress(HttpServletRequest request, HttpServletResponse response,ModelMap modelMap) {

        String id = request.getParameter("id");

        modelMap.put("flag_id", id);
        return new ModelAndView("modules/app/user/receivingAddress");
    ...
    public String feedback(HttpServletRequest request, HttpServletResponse response) {
        ...
        return "modules/app/user/feedback";
    }
...
//            userService.updateAppLoginToken(user);
    ...
    public String forgetPasswordStep1Post(HttpServletRequest request, HttpServletResponse response) {
        ...
        String mobile = WebUtils.getCleanParam(request, FormAuthenticationFilter.DEFAULT_USERNAME_PARAM);;
