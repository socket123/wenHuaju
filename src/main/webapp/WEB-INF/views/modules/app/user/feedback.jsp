...
<head>
    ...
    <title>问题反馈</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/app/mui/css/mui.min.css" />
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/app/mui/css/feedback.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/app/mui/css/page/feedback.css">
...
<div class="mui-bar mui-bar-nav header_nav">
    ...
    <button id="submit" class="mui-btn mui-btn-blue mui-btn-link mui-pull-right header_nav_color" style="display: none;">发送</button>
    <button id="submitFeedback" class="mui-btn mui-btn-blue mui-btn-link mui-pull-right header_nav_color">发送</button>
    <h1 class="mui-title header_nav_color" data="${pageContext.request.contextPath}" >问题反馈</h1>
</div>
<div class="mui-content mui_content_divs">
    ...
    <div id='image-list' class="row image-list" style="display: none;">
...
<script src=" ${pageContext.request.contextPath}/static/app/mui/js/feedback.js" type="text/javascript" charset="utf-8"></script>
<script src="${pageContext.request.contextPath}/static/app/mui/js/page/feedback.js"></script>
